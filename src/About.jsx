...
function About() {
  return (
    <div id="about" className="bg-zinc-950 px-6 sm:px-10 pb-15 pt-30 text-white tracking-tight">
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-30 mb-8 items-start lg:items-stretch">
        <p className="text-3xl sm:text-[2rem] font-medium tracking-tight leading-snug self-start lg:self-end">About Me</p>
        <p className="text-base sm:text-lg text-zinc-400 leading-relaxed tracking-tight max-w-5xl">
       ...
       <div className="bg-white h-100 flex items-stretch" style={{ backgroundImage: `url(${CodeImage})`, backgroundSize: 'cover', backgroundPosition: 'center', width: '100%', height: '400px' }}>
        <p className="text-5xl sm:text-6xl lg:text-7xl font-semibold tracking-tight leading-[1.02] self-end p-4 mix-blend-difference">Passionate about <br/>Learning & Developing</p>
       </div>
